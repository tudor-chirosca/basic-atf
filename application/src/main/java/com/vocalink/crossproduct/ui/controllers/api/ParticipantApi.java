...
public interface ParticipantApi {
  ...
  @ApiResponses({
      @ApiResponse(code = 200, message = "Managed participant details retrieved successfully", response = ParticipantConfigurationDto.class),
      @ApiResponse(code = 400, message = "Some of the request params are invalid")
  })
  ResponseEntity<ParticipantConfigurationDto> getManagedParticipantDetails(final ClientType clientType,
