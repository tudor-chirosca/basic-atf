...
open class BPSTestConfig {
    ...
    open fun testBpsProperties(): BPSProperties {
        ...
        props.paths = hashMapOf<String, Detail>(
            ...
            Pair("statuses-path", Detail("MOCK", "/reference/status/P27-SEK/FILE/readAll")),
            Pair("output-flow-references-path", Detail("MOCK", "/reference/messages/outputFlow/P27-SEK/readAll")),
            ...
            Pair("settlement-details-path", Detail("MOCK", "/enquiries/settlement/enquiry/P27-SEK/read")),
            ...
            Pair("approval-create-path", Detail("MOCK", "/approvals/create/P27-SEK")),
            Pair("confirm-approval-path", Detail("MOCK", "/approvals/P27-SEK")),
            Pair("batch-approval-create-path", Detail("MOCK", "/enquiries/batch/cancellation/P27-SEK")),
            ...
            Pair("participant-configuration-path", Detail("MOCK", "/participants/P27-SEK/aggregate/configuration")),
