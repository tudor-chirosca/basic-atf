...
import com.vocalink.crossproduct.adapter.bps.AdapterConfig
...
@SpringBootTest(classes = [BPSTestConfig::class, BPSRetryWebClientConfig::class, AdapterConfig::class])
