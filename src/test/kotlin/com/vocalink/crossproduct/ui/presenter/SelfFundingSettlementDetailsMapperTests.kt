...
class SelfFundingSettlementDetailsMapperTests {
    ...
    fun `should get Self Funding Settlement Details DTO for 2 cycles`() {
        ...
        assertEquals(BigDecimal.TEN, result.previousPosition.customerCreditTransfer.credit)
        assertEquals(BigDecimal.ZERO, result.previousPosition.customerCreditTransfer.netPosition)
        assertEquals(BigDecimal.TEN, result.previousPosition.paymentReturn.debit)
        assertEquals(BigDecimal.ONE, result.previousPosition.paymentReturn.credit)
        assertEquals(BigDecimal.valueOf(9), result.previousPosition.paymentReturn.netPosition)
